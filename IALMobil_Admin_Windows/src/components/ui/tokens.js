...
export const control =
  'appearance-none outline-none ring-0 focus:ring-0 border-0 border-none w-full box-border m-0 h-9 px-3.5 py-0 rounded-full bg-slate-100 dark:bg-[#1e293b]/60 ' +
...
export const controlArea =
  'appearance-none outline-none ring-0 focus:ring-0 border-0 border-none w-full box-border m-0 px-3.5 py-2.5 rounded-xl bg-slate-100 dark:bg-[#1e293b]/60 ' +
  'text-[13.5px] font-normal text-slate-900 dark:text-slate-100 placeholder:text-slate-400 dark:placeholder:text-slate-500 ' +
